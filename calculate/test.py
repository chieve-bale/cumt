...
force20=[{'xu_hao':0,'wei_zhi':[1,1],'lei_xing':'00','L':0,'duan_dian_jv':[0,0],'duan_dian_zhi':[30000,0],'F':30000,'a': 90},\
...
force2=[{'xu_hao':0,'wei_zhi':[0,1],'lei_xing':'10','L':0,'duan_dian_jv':[2000,2000],'duan_dian_zhi':[15000,15000],'F':15000,'a': 90, 'cos': 0, 'sin': 0},\
...
force38=[{'xu_hao':0,'wei_zhi':[0,1],'lei_xing':'10','duan_dian_jv':[2000,2000],'F':15000},\
...
force35=[{'xu_hao':0,'wei_zhi':[0,1],'lei_xing':'3','L':6000,'duan_dian_jv':[0,0],'duan_dian_zhi':[-10,-10],'F':-10},\
